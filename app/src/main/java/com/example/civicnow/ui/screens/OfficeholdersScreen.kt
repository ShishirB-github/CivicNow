...
fun OfficeholdersScreen(
    ...
    when (civicNowUiState) {
        ...
        is CivicNowUiState.Success -> OfficeholdersResultScreen(
            civicNowUiState.officeholders, navController = navController, modifier = modifier.fillMaxWidth()
        )
...
fun OfficeholdersResultScreen(
    ...
    Surface(
        ...
        Column(modifier = modifier) {
            Text(
                text = "Success: ${officeholders.size} Officeholders retrieved",
